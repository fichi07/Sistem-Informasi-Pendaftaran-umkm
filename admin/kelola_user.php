                                ...
                                <div class="col-12" >
                                    <div class="card-body table-responsive" style="overflow-x:hidden;">
										 <table id="dataTable3" class="table table-hover" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$form=mysqli_query($koneksi,"SELECT * FROM akunuser ORDER BY nama_lengkap ASC");
											$no=1;
											while($b=mysqli_fetch_array($form)){
                                                ...
                                                if(isset($_POST['hapus'])){
                                                    $user = $_POST['nmuser'];
                                                    $query = mysqli_query($koneksi,"delete from akunuser where nama_lengkap='$user'");
                                                    if($query){
                                                        //berhasil bikin
